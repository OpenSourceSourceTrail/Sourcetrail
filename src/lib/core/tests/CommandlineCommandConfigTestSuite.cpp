...
TEST_F(CommandlineCommandConfigFix, emptyArgs) {
  ...
  constexpr std::string_view ResultString =
      ...
      " -h [ --help ]                         Print this help message\n  -t [ --indexer-threads ] arg          Set the number"
      " of threads used for \n                                        indexing (0 uses ideal thread count)\n  -l [ --logging-"
      "enabled ] arg          Enable file/console logging \n                                        <true/false>\n  -L [ --ve"
      "rbose-indexer-logging-enabled ] arg\n                                        Enable additional log of abstract \n     "
      "                                   syntax tree during the indexing. \n                                        <true/fa"
      "lse> WARNING Slows down \n                                        indexing speed\n  -g [ --global-header-search-paths "
      "] arg\n                                        Global include paths (once per path or \n                              "
      "          comma separated)\n  -F [ --global-framework-search-paths ] arg\n                                        Glob"
      "al include paths (once per path or \n                                        comma separated)\n  -s [ --show ]        "
...
TEST_F(CommandlineCommandConfigFix, invalidArg) {
  ...
  constexpr std::string_view ResultString =
      ...
      "                     Enable additional log of abstract \n                                        syntax tree during th"
      "e indexing. \n                                        <true/false> WARNING Slows down \n                              "
      "          indexing speed\n  -g [ --global-header-search-paths ] arg\n                                        Global in"
      "clude paths (once per path or \n                                        comma separated)\n  -F [ --global-framework-se"
      "arch-paths ] arg\n                                        Global include paths (once per path or \n                   "
