...
public:
   ...
   */
  [[nodiscard]] virtual Id getNodeIdForFileNode(const FilePath& filePath) const = 0;
   ...
   */
  [[nodiscard]] virtual Id getNodeIdForNameHierarchy(const NameHierarchy& nameHierarchy) const = 0;
   ...
   */
  [[nodiscard]] virtual std::vector<Id> getNodeIdsForNameHierarchies(const std::vector<NameHierarchy> nameHierarchies) const = 0;
   ...
   */
  [[nodiscard]] virtual NameHierarchy getNameHierarchyForNodeId(Id nodeId) const = 0;
   ...
   */
  [[nodiscard]] virtual std::vector<NameHierarchy> getNameHierarchiesForNodeIds(const std::vector<Id>& nodeIds) const = 0;
   ...
   */
  [[nodiscard]] virtual std::map<Id, std::pair<Id, NameHierarchy>> getNodeIdToParentFileMap(const std::vector<Id>& nodeIds) const = 0;
   ...
   */
  [[nodiscard]] virtual NodeType getNodeTypeForNodeWithId(Id nodeId) const = 0;
   ...
   */
  [[nodiscard]] virtual StorageEdge getEdgeById(Id edgeId) const = 0;
   ...
   * @return A vector of SearchMatch objects representing the matches.
   */
  [[nodiscard]] virtual std::vector<SearchMatch> getSearchMatchesForTokenIds(const std::vector<Id>& tokenIds) const = 0;

  /**
   * @brief Get a graph containing all nodes and edges.
   * @return A shared pointer to a Graph object representing the entire graph.
   */
  [[nodiscard]] virtual std::shared_ptr<Graph> getGraphForAll() const = 0;
   ...
   */
  [[nodiscard]] virtual std::shared_ptr<Graph> getGraphForNodeTypes(NodeTypeSet nodeTypes) const = 0;
   ...
   */
  [[nodiscard]] virtual std::shared_ptr<Graph> getGraphForChildrenOfNodeId(Id nodeId) const = 0;
   ...
   */
  [[nodiscard]] virtual NodeKindMask getAvailableNodeTypes() const = 0;

  /**
   * @brief Get the available edge types in the storage.
   * @return An Edge::TypeMask representing the available edge types.
   */
  [[nodiscard]] virtual Edge::TypeMask getAvailableEdgeTypes() const = 0;
   ...
   */
  [[nodiscard]] virtual std::vector<Id> getNodeIdsForLocationIds(const std::vector<Id>& locationIds) const = 0;
   ...
   */
  [[nodiscard]] virtual std::shared_ptr<TextAccess> getFileContent(const FilePath& filePath, bool showsErrors) const = 0;
   ...
   */
  [[nodiscard]] virtual FileInfo getFileInfoForFileId(Id fileId) const = 0;
   ...
   * @return A FileInfo object containing information about the file.
   */
  [[nodiscard]] virtual FileInfo getFileInfoForFilePath(const FilePath& filePath) const = 0;
   ...
   */
  [[nodiscard]] virtual std::vector<FileInfo> getFileInfosForFilePaths(const std::vector<FilePath>& filePaths) const = 0;

  /**
   * @brief Get storage statistics.
   * @return A StorageStats object containing storage statistics.
   */
  [[nodiscard]] virtual StorageStats getStorageStats() const = 0;

  /**
   * @brief Get the error count information.
   * @return An ErrorCountInfo object containing error count information.
   */
  [[nodiscard]] virtual ErrorCountInfo getErrorCount() const = 0;
   ...
   */
  [[nodiscard]] virtual std::vector<ErrorInfo> getErrorsLimited(const ErrorFilter& filter) const = 0;
   ...
   */
  virtual void removeBookmark(const Id bookmarkId) = 0;

  /**
   * @brief Remove a bookmark category.
   * @param id The ID of the category to remove.
   */
  virtual void removeBookmarkCategory(const Id bookmarkCategoryId) = 0;

  /**
   * @brief Get all node bookmarks.
   * @return A vector of all NodeBookmark objects.
   */
  [[nodiscard]] virtual std::vector<NodeBookmark> getAllNodeBookmarks() const = 0;

  /**
   * @brief Get all edge bookmarks.
   * @return A vector of all EdgeBookmark objects.
   */
  [[nodiscard]] virtual std::vector<EdgeBookmark> getAllEdgeBookmarks() const = 0;

  /**
   * @brief Get all bookmark categories.
   * @return A vector of all BookmarkCategory objects.
   */
  [[nodiscard]] virtual std::vector<BookmarkCategory> getAllBookmarkCategories() const = 0;
   ...
   */
  [[nodiscard]] virtual TooltipInfo getTooltipInfoForTokenIds(const std::vector<Id>& tokenIds, TooltipOrigin origin) const = 0;
